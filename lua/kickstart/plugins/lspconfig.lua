return {
  ...
  },
  {
    ...
    config = function()
      ...
      -- NOTE: Language specific configs like keymaps that can't be set in the
      ...
      -- Not really missing fields as the fields it's asking for are really
      -- noted above in the tables `server`, `ensure_installed`, etc.
